...
public sealed class AuthAuthorisationIntegrationTests : IAsyncLifetime
{
    ...
    private sealed record CreateClientAccountRequest(string UserName, string Email, string Role);
    private sealed record UpdateUserRequest(string Email, string Role, bool IsActive);
    private sealed record UpdateClientAccountRequest(string Email, string Role, bool IsActive);
    ...
    private sealed record ManagedUserEnvelope(int Id, string UserName, string Email, string Role, string IdentityType, bool IsActive);
    private sealed record ClientAccountEnvelope(int Id, string UserName, string Email, string Role, bool IsActive);
