...
public interface ICardArchiveService
{
    ...
    Task<ApiResult<ArchivedCardDetailDto>> GetArchivedCardAsync(int boardId, int boardCardId, int actorUserId);
    ...
    Task<ApiResult<CardDto>> UnarchiveCardAsync(int boardId, int boardCardId, int actorUserId);
}
