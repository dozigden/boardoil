...
namespace BoardOil.Ef.Migrations
{
    ...
    [Migration("20260912173931_AddBoardCardAttachmentThumbnailsSetting")]
    partial class AddBoardCardAttachmentThumbnailsSetting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoardOil.Data.Abstractions.Entities.EntityAttachmentDownloadTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("AttachmentDownloadTickets", null, t =>
                        {
                            t.HasCheckConstraint("CK_AttachmentDownloadTickets_Credential", "(PersonalAccessTokenId IS NOT NULL AND OAuthTokenId IS NULL AND OAuthAuthorizationId IS NULL) OR (PersonalAccessTokenId IS NULL AND OAuthTokenId IS NOT NULL AND OAuthAuthorizationId IS NOT NULL)");

                            t.HasCheckConstraint("CK_AttachmentDownloadTickets_Owner", "(CardId IS NOT NULL AND ArchivedCardId IS NULL) OR (CardId IS NULL AND ArchivedCardId IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("BoardOil.Data.Abstractions.Entities.EntityAttachmentTransferAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("Operation", "TicketId");

                    b.HasIndex("Outcome", "OccurredAtUtc");

                    b.ToTable("AttachmentTransferAudits", (string)null);
                });

            modelBuilder.Entity("BoardOil.Data.Abstractions.Entities.EntityAttachmentUploadTicket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("AttachmentUploadTickets", null, t =>
                        {
                            t.HasCheckConstraint("CK_AttachmentUploadTickets_ByteLength", "DeclaredByteLength >= 0");

                            t.HasCheckConstraint("CK_AttachmentUploadTickets_Credential", "(PersonalAccessTokenId IS NOT NULL AND OAuthTokenId IS NULL AND OAuthAuthorizationId IS NULL) OR (PersonalAccessTokenId IS NULL AND OAuthTokenId IS NOT NULL AND OAuthAuthorizationId IS NOT NULL)");

                            t.HasCheckConstraint("CK_AttachmentUploadTickets_State", "State IN (0, 1, 2, 3)");
                        });
                });
            ...
            modelBuilder.Entity("BoardOil.Data.Abstractions.Entities.EntityBoard", b =>
                {
                    ...
                    b.Property<bool>("CardAttachmentThumbnailsEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("BoardOil.Data.Abstractions.Entities.EntityAttachmentDownloadTicket", b =>
                {
                    b.HasOne("BoardOil.Data.Abstractions.Entities.EntityCardAttachment", "Attachment")
                        .WithMany()
