    ...
    IMcpAuthorisationService authorisationService) : McpToolBase<BoardGetInput, McpBoardSnapshot>(authorisationService)
{
    ...
    public override McpToolDefinition Definition { get; } =
        new(ToolNames.BoardGet, "Get a board snapshot including columns and cards. Card descriptions are omitted; use card_get for full text.", ToolSchemas.BoardGetInput, ToolSchemas.ObjectOutput, MachinePatScopes.McpRead, ToolDiscoveryOrder.BoardGet);
