    ...
    IMcpAuthorisationService authorisationService) : McpToolBase<CardGetInput, McpCardSnapshot>(authorisationService)
{
    ...
    public override McpToolDefinition Definition { get; } =
        new(ToolNames.CardGet, "Get a card snapshot including description, tags, comments, and attachment metadata (not file contents).", ToolSchemas.CardGetInput, ToolSchemas.ObjectOutput, MachinePatScopes.McpRead, ToolDiscoveryOrder.CardGet, McpToolBehaviours.ReadOnly);
